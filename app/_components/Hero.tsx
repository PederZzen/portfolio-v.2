    ...
    <section className="relative flex min-h-[calc(100vh-5rem)] flex-col items-center justify-center py-12 md:py-16">
      <div className="mx-auto flex w-full max-w-5xl flex-col items-center gap-15 md:gap-12 lg:max-w-6xl lg:flex-row lg:items-center lg:justify-center lg:gap-16 xl:max-w-7xl">
        <div className="grid grid-cols-1 gap-15 md:grid-cols-2">
          <div className="order-2 md:order-1 flex max-w-xl flex-col items-center text-center px-8 md:px-0 md:items-start  md:text-left justify-center">
            <Reveal>
            ...
            <Reveal delay={0.24} className="mt-6 flex items-center justify-center gap-4">
              <Link
                href={links.gitHub}
      ...
      <div className="absolute bottom-6 left-1/2 hidden -translate-x-1/2 transition-all duration-700 delay-700 md:block">
        <a
          href="#work"
          onClick={(event) => {
            event.preventDefault();
